...
import SaveProductToBoardModal from "../ProductsContainer/Product/SaveProductToBoardModal/SaveProductToBoardModal";
				...
				<main className="commentsContainer">
					...
					<div className="comments">
						...
						<div className="commentBox">
							{this.state.productComments &&
							this.state.productComments.map(comment => {
								return (
									<Comment
