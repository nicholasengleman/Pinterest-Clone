...
class Comment extends React.Component {
  ...
  openEditCommentWindow = event => {
    this.toggleCommentEditMenu(event);
    this.props.openEditCommentWindow(
      this.props.productID,
      this.props.commentId
    );
  };
          ...
          <div className="editCommentButtonContainer" tabIndex="0">
            ...
            {this.state.OpenCommentEditMenu && (
              <div className="tooltip">
                <div
                  className="tooltipActions first"
                  onClick={this.openEditCommentWindow}
                >
                  <Text bold inline align="center" color="darkGray" size="md">
                    Edit
                  </Text>
                </div>
                <div
                  className="tooltipActions second"
