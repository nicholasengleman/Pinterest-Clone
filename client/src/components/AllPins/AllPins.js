			...
			<div>
				<Link to='/'>
					<div className='homepageLink wider'>
						...
						<Text bold size='md'>Back to Home</Text>
					</div>
				</Link>
								...
								<Link to={`/products/${pin.productID}`}>
									<div className="pin">
											...
											<IconButton accessibilityLabel="delete this pin"
														...
														iconColor="red"
														size="md"
														onClick={(event) => this.deletePinFromBoard(event, pin.boardID, pin.productID, pin.productImage)}
											/>
											</span>
										...
										<br/>
										<div><Text>{pin.productDescription}</Text></div>
										<br/>
										<div><Text>${pin.productID}</Text></div>
									</div>
								</Link>
							))
